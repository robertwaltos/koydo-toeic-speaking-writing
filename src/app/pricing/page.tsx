...
export const metadata: Metadata = {
  title: "Pricing — Toeic Speaking Writing Premium",
  description: "Unlock unlimited Toeic Speaking Writing practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=toeic-speaking-writing&cadence=annual`;
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Toeic Speaking Writing Premium
        </h1>
