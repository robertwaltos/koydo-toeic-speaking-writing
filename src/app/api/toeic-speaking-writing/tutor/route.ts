...
const EXAM_ID = "toeic-speaking-writing";
const EXAM_DISPLAY_NAME = "TOEIC Speaking & Writing";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover all TOEIC Speaking tasks (read aloud, describe picture, respond to questions, express opinion) and Writing tasks (write sentences, respond to written request, write opinion essay). Align to ETS TOEIC SW.
